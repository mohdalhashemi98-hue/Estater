  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-white rounded-xl border border-surface-border p-4 animate-fade-in animate-stagger-1">
        ...
        <p className="text-2xl font-semibold text-text-primary mt-0.5">{data.total_properties}</p>
      </div>

      <div className="bg-white rounded-xl border border-surface-border p-4 animate-fade-in animate-stagger-2">
        <div className="w-8 h-8 rounded-lg bg-surface-overlay flex items-center justify-center mb-2.5">
          <DollarSign className="w-4 h-4 text-text-muted" />
        </div>
        <p className="text-xs text-text-muted">Total Invested</p>
        <p className="text-2xl font-semibold text-text-primary mt-0.5">{formatCurrency(data.total_purchase_value)}</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-surface-border p-4 animate-fade-in animate-stagger-3">
        ...
        <p className="text-2xl font-semibold text-text-primary mt-0.5">{formatCurrency(data.total_current_value)}</p>
      </div>

      <div className="bg-white rounded-xl border border-surface-border p-4 animate-fade-in animate-stagger-4">
        <p className="text-xs text-text-muted mb-2">Total Gain/Loss</p>
